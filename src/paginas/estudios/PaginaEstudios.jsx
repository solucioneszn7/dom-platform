...
export default function PaginaEstudios() {
  ...
  // Seed fallback si vacío (solo para visualización, NO persiste en Firestore hasta
  // que el usuario interactúe — al darle ¡VAMOS! o "Crear proyecto en tablero" se materializa).
  useEffect(() => {
