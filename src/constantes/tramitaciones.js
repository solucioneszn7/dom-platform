...
export const PERMISOS = {
  [ROLES.ADMIN]:            { verTodo: true, editarUsuarios: true, verMargenes: true, exportarTodo: true, aprobar: true, editarCert: true, eliminarCert: true, editarViabilidad: true },
  [ROLES.DIRECTOR_GENERAL]: { verTodo: true, editarUsuarios: false, verMargenes: true, exportarTodo: true, aprobar: true, editarCert: true, eliminarCert: true, editarViabilidad: false },
  [ROLES.JEFE_DEPTO]:       { verTodo: false, editarUsuarios: false, verMargenes: true, exportarTodo: true, aprobar: true, editarCert: true, eliminarCert: true, editarViabilidad: true },
  [ROLES.TECNICO_ESTUDIO]:  { verTodo: false, editarUsuarios: false, verMargenes: true, exportarTodo: false, aprobar: false, editarCert: true, eliminarCert: false, editarViabilidad: true },
  [ROLES.JEFE_OBRA]:        { verTodo: false, editarUsuarios: false, verMargenes: false, exportarTodo: false, aprobar: false, editarCert: false, eliminarCert: false, editarViabilidad: false },
  [ROLES.ENCARGADO]:        { verTodo: false, editarUsuarios: false, verMargenes: false, exportarTodo: false, aprobar: false, editarCert: false, eliminarCert: false, editarViabilidad: false },
  [ROLES.GESTOR]:           { verTodo: false, editarUsuarios: false, verMargenes: true, exportarTodo: false, aprobar: false, editarCert: true, eliminarCert: false, editarViabilidad: true },
  [ROLES.CLIENTE]:          { verTodo: false, editarUsuarios: false, verMargenes: false, exportarTodo: false, aprobar: false, editarCert: false, eliminarCert: false, editarViabilidad: false },
}

// Fases del workflow de estudios
export const FASES_PROYECTO = {
  ESTUDIO: 'estudio',           // Análisis de propuesta
  LICITACION: 'licitacion',     // Presentación a concurso
  ADJUDICADO: 'adjudicado',     // Contrato firmado
  EJECUCION: 'ejecucion',       // Obra en curso
  RECEPCION: 'recepcion',       // Entrega
  GARANTIA: 'garantia',         // Post-entrega
}
